...
- [ ] CTA לוואטסאפ בסוף
- [ ] עדכון ב-sitemap.js
- [ ] **בדיקת מהירות מובייל** (PageSpeed/Lighthouse) — רוב המטופלים מחפשים מהנייד כשהם בכאב
- [ ] אחרי deploy: בקשת אינדקסציה ב-GSC

### 7. אסטרטגיית "טריות" (Freshness)
גוגל מעדיף אתרים חיים. **כל מאמר חדש משדר שהקליניקה מעודכנת ב-2026 בשיטות החדישות** — זה משפיע על הדירוג של כל האתר, לא רק של המאמר עצמו.
- עדיפות גבוהה למאמרים על טרנדים/שיטות חדישות (לדוגמה: פריון, long COVID, שיטות דונג מתקדמות)
- שואפים ל-1-2 מאמרים חדשים בחודש
