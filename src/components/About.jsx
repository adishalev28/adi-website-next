      ...
      <div className="about-grid">
        ...
        <div>
          ...
          <p style={{ fontSize: "16px", color: C.barkLight, lineHeight: 1.9, margin: "0 0 16px" }}>
            בוגר <strong style={{ color: C.bark }}>מכללת רידמן</strong> לרפואה סינית, מטפל משנת 2016 עם מעל 500 מטופלים. במקביל לקליניקה הפרטית אני מטפל ב<strong style={{ color: C.bark }}>מכבי טבעי</strong> מעל 6 שנים בדיקור סיני ושיאצו. מתמחה בדיקור, שיאצו, כוסות רוח וצמחי מרפא סיניים.
          </p>
          <p style={{ fontSize: "16px", color: C.barkLight, lineHeight: 1.9, margin: "0 0 16px" }}>
