  ...
  return (
    <Section bg={C.cream} style={{ paddingTop: "60px" }} id="for-whom">
      <div style={{ maxWidth: "820px", margin: "0 auto", textAlign: "center" }}>
        <div style={{ color: C.sageDark, fontSize: "12px", fontWeight: 700, letterSpacing: "3px", marginBottom: "12px" }}>למי זה מתאים</div>
        ...
        <div style={{
          ...
          <span style={{ color: C.sageDark, marginInline: "10px" }}>✦</span>
