...
const REVIEWS = [
  { text: "הגעתי לעדי אחרי שעברתי אצל מספר נוירולוגים בניסיון לטפל במיגרנות שהלכו והחמירו. <strong>המיגרנות היו בתדירות של 3-4 פעמים בשבוע.</strong> כעבור מספר טיפולים קטן יכולתי לראות כבר ירידה משמעותית ובסוף הפסקתי לחלוטין לסבול ממיגרנות. עדי תמיד סבלני, מקשיב ומסביר כל דבר שעושה.", name: "איתמר בורגר", sub: "מיגרנות כרוניות" },
  ...
  { text: "הגעתי לעדי עם כל מיני בעיות שרציתי לטפל בהן, והוא פשוט מקסים. ממש הרגשתי שהוא איתי בזה – מקשיב, חושב, ומנסה להבין מה הכי יעזור, לא עובד על אוטומט, וכבר אחרי כמה מפגשים המצב השתפר :) מעבר לזה שהוא מקצועי, הוא גם נותן תחושה ממש נעימה ובטוחה, וזה בעיניי שווה מלא. יצאתי עם הרגשה טובה ושבאמת אכפת לו, וזה לא מובן מאליו. ממליצה עליו ממש!!", name: "ג'יאב סגל", sub: "טיפול מותאם אישית" },
  { text: "חוויה מדהימה. הגעתי לקליניקה של עדי במצב של כאבים בכל הגוף ובעיקר בגב. טיפול מסור ביותר - הגעתי הכי סקפטית שיש וקיבלתי טיפול בדיקור בשילוב של עיסויים ברמה הכי גבוהה שיש. מעבר לכך אנושיות ואמפטיה כזאת שאין באף מקום... ממליצה בחום!", name: "בטי להב", sub: "כאבי גב - דיקור ושיאצו" },
  { text: "ממליצה בחום על עדי שלו. הגעתי אליו בעקבות כאבי ראש ועיניים חזקים (אובאיטיס). עדי הצליח לסייע לי לייצב את המצב, והמחלה חוזרת לעיתים רחוקות יותר ובעוצמה פחותה. אני מצליחה לחזור לשגרה שלי בראש שקט.", name: "Marina Fischer", sub: "כאבי ראש ועיניים (אובאיטיס)" },
  ...
  { text: "מטפל מדהים!!! אחד הטובים! אני עושה אצלו כבר כמה שנים שיאצו, יוצאת כמו חדשה בכל פעם!!!", name: "Nataly CM", sub: "שיאצו" },
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noreferrer" className="google-badge" style={{
            ...
            <Stars />
            <span style={{ fontSize: "13px", color: C.barkLight, fontWeight: 500 }}>מבוסס על 35 ביקורות</span>
          </a>
        </div>
      </div>
