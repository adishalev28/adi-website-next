...
const REVIEWS = [
  { text: "הגעתי לעדי אחרי שעברתי אצל מספר נוירולוגים בניסיון לטפל במיגרנות שהלכו והחמירו. המיגרנות היו בתדירות של 3-4 פעמים בשבוע. כעבור מספר טיפולים קטן יכולתי לראות כבר ירידה משמעותית ובסוף הפסקתי לחלוטין לסבול ממיגרנות. עדי תמיד סבלני, מקשיב ומסביר כל דבר שעושה.", name: "איתמר בורגר", sub: "מיגרנות כרוניות" },
