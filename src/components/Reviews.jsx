...
import { REVIEWS, REVIEW_COUNT } from "@/lib/reviewsData";
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "40px" }}>
          ...
          <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noreferrer" className="google-badge" style={{
            ...
            <Stars />
            <span style={{ fontSize: "13px", color: C.barkLight, fontWeight: 500 }}>מבוסס על {REVIEW_COUNT} ביקורות</span>
          </a>
        </div>
      </div>
