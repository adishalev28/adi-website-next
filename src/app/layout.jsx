...
export const metadata = {
  ...
  description:
    "סובלים מכאב, מתח או נדודי שינה? דיקור סיני, שיאצו וכוסות רוח בראשון לציון. אבחון מעמיק וטיפול בשורש, 8+ שנות ניסיון ו-35 המלצות 5 כוכבים. תיאום בוואטסאפ.",
  keywords: [
    "דיקור סיני",
  ...
  openGraph: {
    title: "דיקור סיני בראשון לציון - הקלה בכאב ובמתח | עדי שלו",
    description: "סובלים מכאב, מתח או נדודי שינה? דיקור סיני, שיאצו וכוסות רוח בראשון לציון. אבחון מעמיק וטיפול בשורש, 8+ שנות ניסיון ו-35 המלצות 5 כוכבים.",
  ...
  twitter: {
    ...
    title: "דיקור סיני בראשון לציון - הקלה בכאב ובמתח | עדי שלו",
    description: "דיקור סיני, שיאצו וכוסות רוח בראשון לציון. הקלה בכאב, מתח ושינה. 8+ שנות ניסיון ו-35 המלצות 5 כוכבים.",
