...
export const metadata = {
  ...
  description:
    "סובלים מכאב, מתח או נדודי שינה? דיקור סיני, שיאצו וכוסות רוח בראשון לציון. אבחון מעמיק וטיפול בשורש, מטפל משנת 2016 ו-37 המלצות 5 כוכבים. תיאום בוואטסאפ.",
  keywords: [
    "דיקור סיני",
  ...
  twitter: {
    ...
    title: "דיקור סיני בראשון לציון - הקלה בכאב ובמתח | עדי שלו",
    description: "דיקור סיני, שיאצו וכוסות רוח בראשון לציון. הקלה בכאב, מתח ושינה. מטפל משנת 2016 ו-37 המלצות 5 כוכבים.",
