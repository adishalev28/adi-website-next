...
export const metadata = {
  ...
  title: "דיקור סיני בראשון לציון - עדי שלו | 33 המלצות 5 כוכבים",
  description:
    "מטפל ברפואה סינית בראשון לציון - דיקור, שיאצו, צמחי מרפא וכוסות רוח. 33 ביקורות חמש כוכבים, 6+ שנות ניסיון קליני. אבחון מעמיק וטיפול בשורש. תיאום בוואטסאפ.",
  keywords: [
    "דיקור סיני",
  ...
  openGraph: {
    title: "דיקור סיני בראשון לציון - עדי שלו | 33 המלצות 5 כוכבים",
    description: "מטפל ברפואה סינית בראשון לציון - דיקור, שיאצו, צמחי מרפא וכוסות רוח. 33 ביקורות, 6+ שנות ניסיון קליני. אבחון מעמיק וטיפול בשורש.",
  ...
  twitter: {
    ...
    title: "דיקור סיני בראשון לציון - עדי שלו | 33 המלצות",
    description: "מטפל ברפואה סינית בראשון לציון - דיקור, שיאצו, צמחי מרפא. 33 ביקורות 5 כוכבים, 6+ שנות ניסיון.",
