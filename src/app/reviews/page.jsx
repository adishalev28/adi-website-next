...
export const metadata = {
  ...
  description: `המלצות על עדי שלו - דיקור סיני ושיאצו בראשון לציון. ${REVIEW_COUNT} ביקורות מאומתות בגוגל, כולן 5 כוכבים. חוות דעת של מטופלים על כאבי גב, מיגרנות, שיתוק פנים ושינה.`,
  keywords:
