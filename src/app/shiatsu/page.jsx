...
const FAQ_ITEMS = [
  ...
  { q: "כמה טיפולי שיאצו צריך?", a: "מצב חריף כמו צוואר תפוס לרוב משתחרר מהר. כאבי כתפיים ממושכים דורשים סדרה ארוכה יותר - אין מספר קבוע, זה תלוי בוותק הבעיה ובאיך שהגוף מגיב. אחרי הטיפול הראשון אני כבר יודע להעריך את הכיוון. רבים ממשיכים בטיפול תחזוקתי אחת לשבוע-שבועיים." },
...
export const metadata = {
  title: "שיאצו בראשון לציון | עדי שלו - 39 המלצות 5 כוכבים",
  description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח בכתפיים, כאבי גב, צוואר וכאבים כרוניים. 39 ביקורות 5 כוכבים, מטפל משנת 2016. תיאום בוואטסאפ.",
  keywords: [
    "שיאצו",
    "שיאצו בראשון לציון",
    "טיפול שיאצו",
  ...
  openGraph: {
    title: "שיאצו בראשון לציון | עדי שלו - 39 המלצות 5 כוכבים",
    description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח, כאבי גב וצוואר. 39 ביקורות 5 כוכבים, כעשר שנות ניסיון קליני.",
...
export default function ShiatsuPage() {
  return (
    <>
      ...
      <Section bg={C.cream}>
        <AnswerBlock>
          שיאצו הוא טיפול לחיצות יפני שנעשה בלבוש מלא, בלי שמנים ובלי לישה. אני עובד עם
          אצבעות, כפות ידיים ומרפקים על מרידיאנים - ערוצי האנרגיה של הרפואה הסינית - ומשלב
          מתיחות עדינות. זה שונה מעיסוי רגיל: המטרה היא לא רק לרכך שריר תפוס אלא להחזיר
          תנועה למערכת כולה. בקליניקה שלי בראשון לציון שיאצו עוזר במיוחד לכתפיים תפוסות,
          כאבי גב וצוואר ומתח שלא משתחרר. תיאום תור בוואטסאפ.
        </AnswerBlock>
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0", position: "relative" }}>
            {[
              ...
              { num: "3", title: "תוצאות והמשך", text: "אחרי שיאצו רוב האנשים מרגישים רגיעה עמוקה, גמישות משופרת ופחות כאב. במצבים כרוניים בדרך כלל נדרשת סדרה, ואת אורכה נקבע יחד לפי ההתקדמות." },
            ].map((step, idx, arr) => (
          ...
          <div className="shiatsu-myths" style={{
            ...
            {[
              ...
              },
              {
                ...
                truth: "מצבים חריפים (צוואר תפוס, מתח חריף) משתחררים מהר. רוב האנשים מרגישים הקלה ניכרת כבר מהטיפול הראשון.",
              },
              {
