...
export const metadata = {
  title: "שיאצו בראשון לציון | עדי שלו - 36 המלצות 5 כוכבים",
  description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח בכתפיים, כאבי גב, צוואר וכאבים כרוניים. 36 ביקורות 5 כוכבים, 8+ שנות ניסיון. שיאצו מסורתי + נגיעות אישיות. תיאום בוואטסאפ.",
  keywords: [
    "שיאצו",
    "שיאצו בראשון לציון",
    "טיפול שיאצו",
  ...
  openGraph: {
    title: "שיאצו בראשון לציון | עדי שלו - 36 המלצות 5 כוכבים",
    description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח, כאבי גב וצוואר. 36 ביקורות 5 כוכבים, 8+ שנות ניסיון קליני.",
