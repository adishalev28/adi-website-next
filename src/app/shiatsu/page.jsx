...
export const metadata = {
  ...
  description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח בכתפיים, כאבי גב, צוואר וכאבים כרוניים. 37 ביקורות 5 כוכבים, מטפל משנת 2016. תיאום בוואטסאפ.",
  keywords: [
    "שיאצו",
    "שיאצו בראשון לציון",
    "טיפול שיאצו",
  ...
  openGraph: {
    title: "שיאצו בראשון לציון | עדי שלו - 37 המלצות 5 כוכבים",
    description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח, כאבי גב וצוואר. 37 ביקורות 5 כוכבים, כעשר שנות ניסיון קליני.",
