...
export const metadata = {
  title: "שיאצו בראשון לציון | עדי שלו - 35 המלצות 5 כוכבים",
  description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח בכתפיים, כאבי גב, צוואר וכאבים כרוניים. 35 ביקורות 5 כוכבים, 6+ שנות ניסיון. שיאצו מסורתי + נגיעות אישיות. תיאום בוואטסאפ.",
  keywords: [
    "שיאצו",
    "שיאצו בראשון לציון",
    "טיפול שיאצו",
  ...
  openGraph: {
    title: "שיאצו בראשון לציון | עדי שלו - 35 המלצות 5 כוכבים",
    description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח, כאבי גב וצוואר. 35 ביקורות 5 כוכבים, 6+ שנות ניסיון קליני.",
