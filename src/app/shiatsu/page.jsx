...
export const metadata = {
  ...
  description: "טיפולי שיאצו מקצועיים בראשון לציון - שחרור מתח בכתפיים, כאבי גב, צוואר וכאבים כרוניים. 37 ביקורות 5 כוכבים, מטפל משנת 2016. שיאצו מסורתי + נגיעות אישיות. תיאום בוואטסאפ.",
  keywords: [
    "שיאצו",
    "שיאצו בראשון לציון",
    "טיפול שיאצו",
