...
export const metadata = {
  ...
  description: "שרירים תפוסים שלא עוברים? כוסות רוח משחררות מתח עמוק תוך 30 דקות, משפרות זרימת דם ומקלות על כאבי גב וצוואר. שילוב עם דיקור להעצמת התוצאה. 37 המלצות 5 כוכבים בגוגל.",
  keywords: [
    "כוסות רוח",
