...
export const metadata = {
  ...
  description: "שרירים תפוסים שלא עוברים? כוסות רוח משחררות מתח עמוק תוך 30 דקות, משפרות זרימת דם ומקלות על כאבי גב וצוואר. שילוב עם דיקור להעצמת התוצאה. 36 המלצות 5 כוכבים בגוגל.",
  keywords: [
    "כוסות רוח",
  ...
  openGraph: {
    title: "כוסות רוח בראשון לציון - שחרור מיידי לכאב גב | עדי שלו",
    description: "שרירים תפוסים שלא עוברים? כוסות רוח משחררות מתח עמוק תוך 30 דקות. שילוב עם דיקור להעצמה. 36 ביקורות 5 כוכבים. קליניקה פרטית בראשון לציון.",
