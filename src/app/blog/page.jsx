...
const ARTICLES = [
  {
    slug: "shiatsu-vs-massage",
    title: "שיאצו או עיסוי? איך אני בוחר את הטיפול הנכון",
    description: "שאלה שאני שומע הכי הרבה - שיאצו או עיסוי? במציאות זה הרבה יותר מורכב. מתי לבחור שיאצו, מתי עיסוי קליל עם שמן, ומתי שילוב של שניהם.",
    tag: "שיאצו",
    date: "מאי 2026",
    readTime: "8",
    image: "/shiatsu-treatment.jpg",
    imageAlt: "טיפול שיאצו ועיסוי בקליניקה בראשון לציון",
  },
  {
