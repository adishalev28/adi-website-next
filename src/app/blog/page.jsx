...
const ARTICLES = [
  ...
  {
    slug: "knee-pain",
    title: "דיקור סיני לכאבי ברכיים - שחיקת סחוס ופציעות",
    description: "סובלים מכאבי ברכיים? שחיקת סחוס, מניסקוס או ברך של רץ? דיקור סיני בשיטת ד\"ר טאן מפחית כאב ודלקת ומחזיר תנועה, בלי ניתוח.",
    tag: "דיקור סיני",
    date: "אוגוסט 2026",
    readTime: "9",
    image: "/blog-knee-pain.jpg",
    imageAlt: "דיקור סיני לכאבי ברכיים - טיפול בקליניקה בראשון לציון",
  },
  {
    slug: "frozen-shoulder",
    title: "דיקור סיני לכתף קפואה - שחזור טווח תנועה",
    description: "סובלים מכתף קפואה וקושי להרים את היד? דיקור סיני בשיטת ד\"ר טאן מפחית כאב ומשחזר טווח תנועה בהדרגה, בלי ניתוח. מדריך מקיף.",
    tag: "דיקור סיני",
    date: "עודכן אוגוסט 2026",
    readTime: "11",
  ...
  },
  {
    ...
    description: "סובלות מגלי חום, הזעות לילה ונדודי שינה בגיל המעבר? דיקור סיני מוכח מחקרית כטיפול יעיל ובלי תופעות לוואי. מדריך מקיף.",
    tag: "דיקור סיני",
    date: "עודכן אוגוסט 2026",
    readTime: "11",
  ...
  {
    slug: "how-acupuncture-works",
    title: "איך דיקור סיני עובד? המנגנון מאחורי המחטים",
    ...
    date: "עודכן אוגוסט 2026",
    readTime: "6",
    image: "/blog-how-acupuncture-works.jpg",
    imageAlt: "טיפול דיקור סיני בקליניקה בראשון לציון - הכנסת מחט עדינה לנקודת יינטאנג",
  },
  {
    slug: "shiatsu",
    ...
    date: "עודכן אוגוסט 2026",
    readTime: "11",
    image: "/shiatsu-treatment.jpg",
    imageAlt: "טיפול שיאצו בקליניקה בראשון לציון",
  },
  {
    slug: "anxiety",
  ...
  },
  {
    ...
    title: "כאבי גב - המדריך המלא לטיפול ברפואה סינית",
    description: "כל שיטות הטיפול ברפואה סינית בכאבי גב: דיקור, שיאצו, כוסות רוח וצמחי מרפא - מה עובד, למי מתאים וכמה טיפולים צריך.",
    tag: "כאבי גב",
    date: "עודכן אוגוסט 2026",
    readTime: "15",
    image: "/og-blog-back-pain-guide.jpg",
    imageAlt: "טיפול בכאבי גב ברפואה סינית - המדריך המלא, קליניקה בראשון לציון",
  },
  {
    slug: "back-pain",
