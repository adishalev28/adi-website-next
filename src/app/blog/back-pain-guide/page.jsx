...
const FAQ_ITEMS = [
  { q: "האם דיקור סיני באמת עוזר לכאבי גב?", a: "כן. מחקרים קליניים רבים הוכיחו שדיקור סיני יעיל לכאבי גב חריפים וכרוניים. ארגון הבריאות העולמי ממליץ על דיקור לכאבי גב, ומערכות בריאות רבות בעולם כוללות אותו כטיפול מוכר." },
  { q: "האם הדיקור כואב?", a: "ברוב המקרים לא. המחטים דקות מאוד (0.25 מ\"מ) - דקות פי 10 ממחט רגילה. רוב המטופלים מרגישים תחושה קלה של עקצוץ או כבדות, ורבים נרדמים במהלך הטיפול." },
  { q: "מה עדיף - דיקור או פיזיותרפיה?", a: "שניהם יעילים, אבל הגישה שונה. פיזיותרפיה מתמקדת בחיזוק שרירים ותנועה. דיקור מתמקד בהפחתת כאב, דלקת ובאיזון הגוף מבפנים. רבים מהמטופלים שלי משלבים בין השניים ומדווחים על תוצאות טובות יותר." },
  { q: "האם אפשר לטפל בכאבי גב בהריון?", a: "כן, בהחלט. דיקור סיני בטוח בהריון (עם התאמות) ויעיל במיוחד לכאבי גב תחתון שנפוצים בשליש השני והשלישי." },
];

export const metadata = {
  title: "כאבי גב - המדריך המלא לטיפול ברפואה סינית (2026) | עדי שלו",
  description:
    "כל מה שצריך לדעת על טיפול בכאבי גב ברפואה סינית. דיקור, שיאצו, כוסות רוח וצמחי מרפא - מה עובד, למי מתאים, וכמה טיפולים צריך. מאת עדי שלו, ראשון לציון.",
  keywords:
  ...
  openGraph: {
    title: "כאבי גב - המדריך המלא לטיפול ברפואה סינית (2026) | עדי שלו",
    description: "כל מה שצריך לדעת על טיפול בכאבי גב ברפואה סינית. דיקור, שיאצו, כוסות רוח וצמחי מרפא - מה עובד, למי מתאים, וכמה טיפולים צריך. מאת עדי שלו, ראשון לציון.",
    ...
    <>
      ...
      >
        ...
        <p>
          ...
          הטיפול משלב דיקור עם מנורת חימום וצמחי מרפא שמייבשים רטיבות.
        </p>
        ...
        <p>
          ...
          רוב המטופלים מרגישים שיפור כבר בטיפולים הראשונים.
        </p>
