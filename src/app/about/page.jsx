...
export const metadata = {
  title: "אודות עדי שלו - מטפל ברפואה סינית בראשון לציון",
  description:
    "עדי שלו, בוגר מכללת רידמן, 8+ שנות ניסיון קליני, מעל 500 מטופלים. מתמחה בדיקור סיני (ד\"ר טאן, מאסטר דונג), שיאצו, כוסות רוח וצמחי מרפא.",
  keywords:
    "עדי שלו, עדי שלו רפואה סינית, עדי שלו ראשון לציון, מטפל דיקור סיני ראשון לציון, מטפל שיאצו, מוסמך רפואה סינית",
};
