...
export const metadata = {
  title: "עדי שלו - רפואה סינית בראשון לציון | 36 המלצות 5 כוכבים",
  description:
    "8 שנות ניסיון, 6+ במכבי טבעי, 36 ביקורות 5 כוכבים בגוגל. מתמחה בשיטות ד\"ר טאן ומאסטר דונג לכאבים ובעיות פנימיות. קליניקה פרטית במערב ראשון לציון - תיאום בוואטסאפ.",
  keywords:
  ...
  openGraph: {
    title: "עדי שלו - רפואה סינית בראשון לציון | 36 המלצות 5 כוכבים",
    description: "8 שנות ניסיון + 6 שנים במכבי טבעי + 36 ביקורות בגוגל. שיטות ד\"ר טאן ומאסטר דונג. קליניקה פרטית במערב ראשון לציון.",
