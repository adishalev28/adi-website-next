...
export const metadata = {
  title: "מטפל ברפואה סינית בראשון לציון - עדי שלו (רידמן + מכבי טבעי)",
  description:
    "מחפשים מטפל ברפואה סינית בראשון לציון? אני עדי שלו, בוגר רידמן עם 8 שנות ניסיון. דיקור (ד\"ר טאן ומאסטר דונג), שיאצו וכוסות רוח. גם במכבי טבעי.",
  keywords:
  ...
  openGraph: {
    title: "מטפל ברפואה סינית בראשון לציון - עדי שלו",
    description: "בוגר רידמן עם 8 שנות ניסיון. מתמחה בשיטות ד\"ר טאן ומאסטר דונג. מטפל גם במכבי טבעי.",
