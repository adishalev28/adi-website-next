...
const ABOUT_FAQ = [
  ...
  },
  {
    ...
    a: "אני מטפל משנת 2016 - כעשר שנים - עם מעל 500 מטופלים שעברו אצלי טיפולים. במכבי טבעי אני נמצא 6+ שנים - מה שאומר שעברתי תהליך ארוך של ביסוס מקצועי וניסיון קליני מגוון.",
  },
  {
...
export const metadata = {
  title: "עדי שלו - רפואה סינית בראשון לציון | 37 המלצות 5 כוכבים",
  description:
    "מטפל משנת 2016, 6+ שנים במכבי טבעי, 37 ביקורות 5 כוכבים בגוגל. מתמחה בשיטות ד\"ר טאן ומאסטר דונג לכאבים ובעיות פנימיות. קליניקה פרטית במערב ראשון לציון - תיאום בוואטסאפ.",
  keywords:
  ...
  openGraph: {
    title: "עדי שלו - רפואה סינית בראשון לציון | 37 המלצות 5 כוכבים",
    description: "מטפל משנת 2016 + 6 שנים במכבי טבעי + 37 ביקורות בגוגל. שיטות ד\"ר טאן ומאסטר דונג. קליניקה פרטית במערב ראשון לציון.",
    ...
    <>
      ...
      >
        <nav style={{ marginBottom: "20px" }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.9)", margin: "0 8px" }}>
            /
          </span>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
            {[
              ...
              {
                title: "מטפל משנת 2016",
                body: "כעשר שנות ניסיון קליני, משנת 2016, עם מעל 500 מטופלים מראשון לציון והסביבה - כאבים כרוניים, מתח נפשי, בעיות שינה ועיכול, פציאליס, מיגרנות ועוד.",
              },
              {
