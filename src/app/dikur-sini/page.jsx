...
export const metadata = {
  ...
  description: "דיקור סיני בראשון לציון - הקלה אמיתית על כאבי גב, צוואר, מיגרנות, חרדה ושינה. שיטות מאסטר דונג וד״ר טאן. 35 ביקורות 5 כוכבים, 6+ שנות ניסיון. תיאום בוואטסאפ.",
  keywords: [
    "דיקור סיני",
  ...
  openGraph: {
    title: "דיקור סיני בראשון לציון | עדי שלו - 35 המלצות 5 כוכבים",
    description: "טיפול דיקור סיני מותאם. שיטות מאסטר דונג וד״ר טאן. הקלה על כאב, מתח וחרדה. 35 ביקורות 5 כוכבים, 6+ שנות ניסיון.",
