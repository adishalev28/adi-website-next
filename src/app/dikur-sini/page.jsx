...
const FAQ_ITEMS = [
  ...
  { q: "כמה טיפולי דיקור צריך?", a: "זה תלוי בוותק של הבעיה ובאיך שהגוף מגיב. מצב חריף לרוב משתפר מהר יותר ממצב שנמשך שנים. כבר בטיפול הראשון, אחרי האבחון, אני יודע להעריך את הכיוון ואנחנו קובעים יחד תוכנית מותאמת - ומעדכנים אותה תוך כדי." },
...
export const metadata = {
  title: "דיקור סיני בראשון לציון לכאבים ומתח | 39 ביקורות 5 כוכבים",
  description: "דיקור סיני בראשון לציון - הקלה אמיתית על כאבי גב, צוואר, מיגרנות, חרדה ושינה. שיטות מאסטר דונג וד״ר טאן. 39 ביקורות 5 כוכבים, מטפל משנת 2016. תיאום בוואטסאפ.",
  keywords: [
    "דיקור סיני",
  ...
  openGraph: {
    title: "דיקור סיני בראשון לציון לכאבים ומתח | 39 ביקורות 5 כוכבים",
    description: "טיפול דיקור סיני מותאם. שיטות מאסטר דונג וד״ר טאן. הקלה על כאב, מתח וחרדה. 39 ביקורות 5 כוכבים, מטפל משנת 2016.",
...
export default function AcupuncturePage() {
  return (
    ...
    <ServiceLayout otherServices={OTHER_SERVICES}>
      ...
      <Section bg={C.cream}>
        <AnswerBlock>
          דיקור סיני הוא החדרת מחטים דקיקות לנקודות מוגדרות בגוף, כדי לשחרר חסימות ולעורר
          את מנגנוני הריפוי הטבעיים. בקליניקה שלי בראשון לציון אני עובד בשיטת ד״ר טאן לכאבים
          (גב, צוואר, כתפיים, מיגרנות והקרנות לרגל או ליד) ובשיטת מאסטר דונג לבעיות פנימיות
          כמו חרדה, שינה ועיכול. כל טיפול מתחיל באבחון - שיחה, דופק ולשון - ומשם נבנית תוכנית
          אישית. תיאום תור בוואטסאפ.
        </AnswerBlock>
        ...
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0", position: "relative" }}>
            {[
              ...
              { num: "3", title: "מעקב והתאמה", text: "בסוף כל טיפול נבדוק התקדמות, ובכל פגישה הטיפול מותאם מחדש לפי המצב העדכני. את אורך הסדרה נקבע יחד תוך כדי, לפי הקצב שבו הגוף מגיב." },
            ].map((step, idx, arr) => (
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto" }}>
          ...
          <article style={{
            ...
            <div style={{ fontSize: "16px", color: C.barkLight, lineHeight: 1.9 }}>
              ...
              <p style={{ margin: "0 0 16px" }}>
                אצל מ&apos; הגוף הגיב מהר במיוחד. כבר אחרי הטיפול הראשון היא הרגישה הקלה משמעותית בכאבי הראש - וזה הלך והשתפר מטיפול לטיפול, עד שהיא כבר הרגישה הרבה יותר טוב.
              </p>
