...
const FAQ_ITEMS = [
  ...
  { q: "האם יש תופעות לוואי לצמחי מרפא סיניים?", a: "כשהפורמולה מותאמת אישית וניתנת במינון נכון, תופעות הלוואי נדירות ולרוב קלות. עם זאת, צמחים הם חומרים פעילים - ולכן חשוב לספר לי על תרופות קבועות שאתם לוקחים, כדי למנוע שילובים לא רצויים. אני עוקב אחרי כל מטופל לאורך הדרך ומתאים את הפורמולה לפי התגובה." },
  { q: "איך לוקחים את הצמחים?", a: "בקליניקה שלי הצמחים ניתנים בצורת גרנולות (אבקה מרוכזת). פשוט מוסיפים מים חמים, מערבבים ושותים - כמו תה. לוקחים 2-3 פעמים ביום." },
  ...
  { q: "האם אפשר לשלב צמחים עם תרופות מערביות?", a: "ברוב המקרים כן, אבל חשוב ליידע אותי על כל תרופה שאתם לוקחים. אני בודק אינטראקציות ומתאים את הפורמולה בהתאם." },
];
  ...
  return (
    <>
        ...
        <div className="herbs-about" style={{ maxWidth: "960px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 340px", gap: "40px", alignItems: "center" }}>
          <div>
            ...
            <p style={{ fontSize: "16px", color: C.barkLight, lineHeight: 1.9, margin: "0" }}>
              בקליניקה שלי בראשון לציון, הצמחים ניתנים בצורת גרגירים (גרנולות) נוחים לשימוש - פשוט מערבבים במים חמים ושותים. הפורמולה מותאמת ומשתנה בהתאם להתקדמות הטיפול.
            </p>
          </div>
          <div style={{
            ...
            <img src="/herbs-treatment.jpg" alt="צמחי מרפא סיניים בקליניקה בראשון לציון - שורשים, עשבי תיבול וגרנולות" style={{ width: "100%", display: "block" }} />
          </div>
        </div>
      </Section>
      ...
      <section style={{ background: C.sand, padding: "48px 24px", textAlign: "center" }}>
        ...
        <a href={waUrl("שלום עדי, רציתי לשאול לגבי צמחי מרפא סיניים 🙂")} target="_blank" rel="noreferrer" style={{
